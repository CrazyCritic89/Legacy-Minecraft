...
public enum ControllerBinding {
    ...
    LEFT_TRIGGER(c-> BindingState.Axis.createTrigger(c,()->0.2f),icon('\uE73B','\uE74C'), InputConstants.MOUSE_BUTTON_RIGHT),
    RIGHT_TRIGGER(c-> BindingState.Axis.createTrigger(c,()->0.2f),icon('\uE73C','\uE74D'), InputConstants.MOUSE_BUTTON_LEFT),
